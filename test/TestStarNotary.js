...
it('can Create a Star', async() => {
    ...
    assert(await instance.tokenIdToStarInfo.call(tokenId) == 'Awesome Star!')
});
...
it('lets user1 put up their star for sale', async() => {
    ...
    assert(await instance.starsForSale.call(starId) == starPrice);
});
...
it('lets user2 buy a star and decreases its balance in ether', async() => {
    ...
    await instance.buyStar(starId, {from: user2, value: balance, gasPrice:50000000});
...
it('can add the star name and star symbol properly', async() => {
    ...
    assert(await instance.name.call() == "Star Token");
    assert(await instance.symbol.call() == "STK");
